  ...
  const validateStep1 = () => {
    ...
    for (let i = 0; i < participantCount; i += 1) {
      ...
      if (!participant.college) {
        nextErrors[`participant_${i}_college`] = 'College selection is required';
      }
            ...
            <Step>
              <div className="form-section">
                ...
                <div className="rules-container" style={{ 
                  ...
                  <h3 style={{ color: '#ffc010', marginBottom: '20px' }}>Ro-Navigator Event Rules</h3>
                  <ul style={{ color: '#ccc', lineHeight: '1.8', paddingLeft: '20px' }}>
                    ...
                    <li>Robot must be autonomous and navigate through obstacles</li>

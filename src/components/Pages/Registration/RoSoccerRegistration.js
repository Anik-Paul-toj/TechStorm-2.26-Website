...
const RoSoccerRegistration = () => {
  ...
  const validateStep1 = () => {
    ...
    for (let i = 0; i < participantCount; i += 1) {
      ...
      if (participant.year && !YEAR_OPTIONS.includes(participant.year)) {
        nextErrors[`participant_${i}_year`] = 'Select a valid year';
      }
  ...
  const handleComplete = async () => {
    ...
    try {
      const result = await submitEventRegistration('Ro-Soccer', formData);
      console.log('Ro-Soccer registration successful:', result);
  ...
  return (
    <div className="registration-page">
      <Breadcrumb
        pageTitle="Register for Ro-Soccer"
        currentPage="Registration"
        bgImage={roSoccerBanner}
      />

      <div className="registration-container">
        <div className="registration-content">
          <div className="registration-header">
            <h1 className="registration-title">Ro-Soccer Registration Form</h1>
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  ...
                  <p style={{ margin: '10px 0' }}>
                    <a
                      href="https://chat.whatsapp.com/E5WZGtAa9lYIciywdQahHr?mode=gi_t"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: '#ffc010' }}
                    >
                      https://chat.whatsapp.com/E5WZGtAa9lYIciywdQahHr?mode=gi_t
                    </a>
                  </p>
                </div>
